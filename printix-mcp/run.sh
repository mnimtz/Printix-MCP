...
# ==============================================================================
# Printix MCP Server v4.6.5 — Home Assistant Add-on Entrypoint
#
...
# v4.6.5: Capture-Server Konfiguration (Architektur-Redesign)
# ─────────────────────────────────────────────────────────────────────────────
...
# v4.6.5: Logging — klar trennen zwischen internem Port und Host-Erreichbarkeit
...
bashio::log.info "╔══════════════════════════════════════════════════════════════╗"
bashio::log.info "║        PRINTIX MCP SERVER v4.6.5 — MULTI-TENANT             ║"
bashio::log.info "╠══════════════════════════════════════════════════════════════╣"
...
if [ "${CAPTURE_ENABLED}" = "true" ]; then
    ...
    # v4.6.5: Prüfe ob capture_server.py existiert
