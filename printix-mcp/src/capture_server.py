"""
Printix Capture Server — Standalone Webhook Endpoint (v4.6.5)
=============================================================
...
# v4.6.5: Sofort loggen — noch vor allen Imports die fehlschlagen koennten
...
def create_capture_app() -> FastAPI:
    ...
    @app.get("/health")
    async def health():
        return {"status": "ok", "service": "capture", "version": "4.6.5"}
...
if __name__ == "__main__":
    ...
    logger.info("╔══════════════════════════════════════════════════════════════╗")
    logger.info("║        PRINTIX CAPTURE SERVER v4.6.5 — STANDALONE           ║")
    logger.info("╠══════════════════════════════════════════════════════════════╣")
