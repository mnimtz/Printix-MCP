...
def _run_report_job(report_id: str) -> None:
    ...
    # v6.9.2: SQL-Config IN den APScheduler-Thread reinpushen, damit
    ...
    # hinterlegt hatte. (Synchronisiert mit printix-mcp-docker v7.6.8.)
    try:
...
def run_report_now(
    ...
    # v6.9.2: SQL-Config defensiv setzen \u2014 siehe _run_report_job-Kommentar.
    try:
