"""
Printix MCP Server — Home Assistant Add-on v4.6.3 (Multi-Tenant)
=================================================================
...
class DualTransportApp:
    ...
    v4.6.3: Wenn CAPTURE_ENABLED=true, laeuft ein separater Capture-Server
    ...
    def __init__(self, sse_app, http_app):
        ...
        # v4.6.3: Pruefe ob separater Capture-Server aktiv (bool statt Port)
...
if __name__ == "__main__":
    ...
    logger.info("╔══════════════════════════════════════════════════════════════╗")
    logger.info("║        PRINTIX MCP SERVER v4.6.3 — MULTI-TENANT            ║")
    logger.info("╠══════════════════════════════════════════════════════════════╣")
    ...
    # v4.6.3: Capture-Status (bool statt Port)
