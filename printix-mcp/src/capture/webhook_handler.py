"""
Capture Webhook Handler — Printix/Tungsten Connector Model (v4.6.4)
===================================================================
...
def _log_raw_request_for_sig_debug(source: str, headers: dict, body_bytes: bytes):
    """
    v4.6.4: Log complete raw request details for signature reverse-engineering.
...
async def handle_webhook(
    ...
    *,
    ...
    """
    Kanonischer Capture-Webhook-Handler (v4.6.4).
    ...
    if not auth_result.success:
        if require_sig:
            ...
            # v4.6.4: Signature mismatch but require_signature=False → continue processing
...
def _handle_debug(
    ...
    """
    Enhanced Debug-Endpoint (v4.6.4):
